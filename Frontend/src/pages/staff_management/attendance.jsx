...
export default function Attendance() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans p-3 md:p-6 animate-in fade-in duration-300">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        ...
        <button onClick={() => setShowApplyModal(true)} className="bg-purple-700 hover:bg-purple-800 text-white px-6 py-2.5 rounded-lg font-bold shadow-md transition-all flex items-center justify-center gap-2 w-full md:w-auto">
      ...
      <div className="flex items-center gap-2 border-b border-gray-200 mb-6 overflow-x-auto">
        {["Attendance", "Leave"].map(tab => (
            <button key={tab} onClick={() => setActiveTab(tab)} className={`px-6 py-3 font-bold text-sm relative whitespace-nowrap ${activeTab === tab ? "text-purple-700" : "text-gray-500"}`}>
                {tab}
            ...
            <div className="flex flex-col xl:flex-row gap-6">
                <div className="flex-1 flex flex-col gap-4">
                    <div className="flex items-center gap-4">
                        <div className="flex items-center gap-2 bg-white border border-gray-300 rounded-lg px-3 py-2 shadow-sm w-full md:w-auto">
                            <span className="text-sm font-bold text-gray-600">Date:</span>
                            <input type="date" value={selectedDate} onChange={(e) => setSelectedDate(e.target.value)} className="text-sm font-medium outline-none text-gray-800 bg-transparent w-full"/>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-2 gap-4 sm:flex">
                    <div className="bg-white p-4 rounded-xl shadow-sm border border-green-100 w-full sm:min-w-[140px] text-center">
                    ...
                    <div className="bg-white p-4 rounded-xl shadow-sm border border-red-100 w-full sm:min-w-[140px] text-center">
