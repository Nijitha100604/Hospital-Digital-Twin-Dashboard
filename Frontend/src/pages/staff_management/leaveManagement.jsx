...
import { 
  Calendar, Search, User, Clock, CheckCircle, 
  XCircle, AlertTriangle, Filter, ChevronDown, 
  MoreHorizontal, Plus, X, FileText, Send
} from "lucide-react";
...
export default function AttendancePage() {
  ...
  const handleViewDetails = (staff) => {
    // Simulate fetching detailed stats
    const stats = {
      ...staff,
    ...
    <div className="min-h-screen bg-gray-50 font-sans p-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        ...
        <button 
          ...
          className="cursor-pointer bg-purple-700 hover:bg-purple-800 text-white px-6 py-2.5 rounded-lg font-bold shadow-md transition-all flex items-center gap-2"
        >
      ...
      <div className="flex items-center gap-2 border-b border-gray-200 mb-6">
        <button 
          ...
          className={`cursor-pointer px-6 py-3 font-bold text-sm transition-all relative ${activeTab === "Attendance" ? "text-gray-800" : "text-gray-500 hover:text-gray-700"}`}
        >
          Attendance
        ...
        <button 
          ...
          className={`cursor-pointer px-6 py-3 font-bold text-sm transition-all relative ${activeTab === "Leave" ? "text-gray-800" : "text-gray-500 hover:text-gray-700"}`}
        >
          Leave Management
